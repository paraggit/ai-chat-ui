...
import { streamChat, getHistory, clearHistory, listSessions, healthCheck, editMessage, regenerateLastResponse, importSession, compareChat, keepResponse } from '../controllers/chatController.js';

const router = Router();

router.get('/sessions', listSessions);
router.post('/chat/compare', compareChat);
router.post('/chat/keep', keepResponse);
